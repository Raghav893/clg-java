...
abstract class Persona {
    ...
    // Every type of persona will show info differently
...
class Studenta extends Persona {
    ...
    public Studenta(int rollNo, String name, String email, String course, double marks) {
        super(name, email);
        this.rollNo = rollNo;
        this.course = course;
        this.marks = marks;
...
class StudentManager implements RecordActionsss {
